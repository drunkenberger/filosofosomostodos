  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        ...
        {/* Icon */}
        <div className="w-14 h-14 rounded-xl bg-naranja/10 flex items-center justify-center mb-5 group-hover:bg-naranja/20 transition-colors">
          <svg className="w-7 h-7 text-naranja" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
          </svg>
        </div>

        <h3 className="text-xl md:text-2xl font-bold text-purpura mb-2 group-hover:text-naranja transition-colors">
          {title}
        </h3>

        <p className="text-sm text-naranja font-semibold mb-4 uppercase tracking-wide">
          {audience}
        </p>
