...
export function Footer() {
  ...
  return (
    <footer id="footer-main-001" className="relative bg-gradient-to-b from-purpura via-purpura/98 to-[#5a5370] text-white overflow-hidden">
      {/* Top gradient line */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-naranja-vibrante via-naranja to-cyan" />

      {/* Decorative elements */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:80px_80px]" />
      <div className="absolute w-[800px] h-[800px] bg-naranja-vibrante/5 rounded-full blur-[150px] -bottom-96 -right-96" />
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6">
        ...
        <div className="py-20 border-b border-white/10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-naranja-vibrante/10 backdrop-blur-sm border border-naranja-vibrante/20 rounded-full px-5 py-2 mb-6">
              <span className="w-2 h-2 bg-naranja-vibrante rounded-full animate-pulse" />
              <span className="text-naranja-vibrante text-sm font-medium tracking-wide">Mantente conectado</span>
            </div>
        ...
        <div className="py-16 grid md:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div className="inline-flex items-center gap-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-5 py-3">
              <div className="flex -space-x-2">
                {[...Array(3)].map((_, i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full bg-gradient-to-br from-naranja-vibrante to-cyan border-2 border-purpura"
                  />
                ))}
              </div>
          ...
          {/* Talleres */}
          <div>
            <h4 className="font-semibold mb-6 text-naranja text-lg">Talleres</h4>
            <ul className="space-y-4">
              <li>
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-naranja-vibrante/50 group-hover:bg-naranja-vibrante group-hover:scale-150 transition-all duration-300" />
          ...
          {/* Navegación rápida */}
          <div>
            <h4 className="font-semibold mb-6 text-naranja text-lg">Navegación</h4>
            <ul className="space-y-4">
              {[
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="group flex items-center gap-2 text-sm text-white/60 hover:text-naranja-vibrante transition-colors duration-300"
              >
